		...
		<form action="" method="post">
			<table>
				...
				<tr>
					...
					<td>:<input name="name" value="<?php echo $name;?>" type="text" placeholder="Enter Name" ><br>
...
<tr>
					...
					<td>:<input name="address" value="<?php echo $address;?>" type="text" placeholder="street Address" placeholder="Enter Address"> <br>
